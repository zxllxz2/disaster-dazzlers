...
**As of November 2022: The \`DuckDBClient\` is now part of the Observable standard library so you don't need to import it anymore. Just [use \`DuckDBClient\`](https://observablehq.com/@observablehq/duckdb) in your notebook without any imports. Note that the API has slightly changed.**
...
import("https://cdn.jsdelivr.net/npm/@duckdb/duckdb-wasm@1.17.0/+esm")
)}
